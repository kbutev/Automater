...
public class StandardDescriptionsDataSource implements ListModel<String> {
    ...
    StandardDescriptionsDataSource createGeneric() {
        return new StandardDescriptionsDataSource();
    }

    public static @NotNull
    StandardDescriptionsDataSource createDataSourceForStandartText(@NotNull List<Description> actions) {
        return new StandardDescriptionsDataSource(actions);
    }

    public static @NotNull
    StandardDescriptionsDataSource createDataSourceForVerboseText(@NotNull List<Description> actions) {
