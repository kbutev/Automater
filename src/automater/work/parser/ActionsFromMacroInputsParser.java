 ...
 * @author Bytevi
 */
public interface ActionsFromMacroInputsParser {
    
    public interface Protocol {
        void onBeginParsing() throws Exception;
        void onParseInput(@NotNull RecorderUserInput input) throws Exception;
        @NotNull List<BaseAction> onFinishParsingMacro() throws Exception;
    }
    
    public class Impl implements Protocol {
