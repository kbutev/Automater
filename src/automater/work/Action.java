...
public class Action extends BaseAction {
    ...
    @Override
    public @Nullable
    String getStandartTooltip() {
        return getStandart();
    }

    @Override
    public @Nullable
    String getVerboseTooltip() {
        return getStandart();
    }
...
class ActionMouseMovement extends Action implements InputMouseMotion {
    ...
    final long time;
    final long duration;
    final @NotNull List<InputMouseMove> movements;
    final @NotNull List<BaseAction> actions;
...
class ActionScreenshot extends Action implements InputScreenshot {
    ...
    final @NotNull String screenshotPath;
