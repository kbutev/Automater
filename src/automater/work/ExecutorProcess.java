...
public interface ExecutorProcess {
    ...
    class Impl implements Protocol, LooperClient, ExecutorProgress {
        ...
        @NotNull private ActionContext.Protocol _context;
        @NotNull private final List<BaseAction> _actions;

        @NotNull private ExecutorTimer.Protocol _timer;
        ...
        public void start(@NotNull Macro macro, @NotNull MacroParameters parameters) throws Exception {
            ...
            synchronized (_lock) {
                ...
                _context = ActionContext.build(_robot, _timer, recordedScreenSize, currentScreenSize);
